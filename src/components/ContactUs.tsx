        ...
        <section id="contact" className="py-20 px-6">
            <div className="container mx-auto max-w-4xl">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[var(--contrast-color)]">
                        Contáctanos
                    </h2>
                    <p className="text-gray-300 text-lg">
                        Estamos aquí para ayudarte con tus necesidades contables.
                    </p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm p-8 md:p-10 rounded-2xl shadow-xl border border-white/10">
                    <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="text-center pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className={`inline-flex items-center justify-center px-8 py-4 bg-[var(--secondary-color)] text-white font-bold rounded-lg hover:bg-opacity-90 transition-all transform hover:scale-105 shadow-lg ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
